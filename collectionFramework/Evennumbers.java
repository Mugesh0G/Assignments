...
public class Evennumbers {
	...
	public static void main(String[] args) {
		...
		int end = sc.nextInt();
		System.out.println("Even Numbers: "+new Evennumbers().saveEvenNumbers(end));
		System.out.println();
		System.out.println("Even Numbers multiply by 2"+new Evennumbers().printEvenNumbers());
		
		
		System.out.println("Enter number to check");
		int find = sc.nextInt();
		System.out.println("-----");
		System.out.println(new Evennumbers().printEvenNumbers(find));
		System.out.println("-----");
